...
// 댓글 페이징 출력 함수
    ...
    // 댓글 목록 함수 호출
    getReplies("/exchangers/replies/" + articleNo);

    // 댓글 페이지 번호 클릭 이벤트
    // $(".pagination").on("click", "li a", function (event) {
    //     event.preventDefault();
    //     replyPageNum = $(this).attr("href");
    //     getReplies("/exchangers/replies/" + articleNo + "/" + replyPageNum);
    // });
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result === "regSuccess") {
                    ...
                    getReplies("/exchangers/replies/" + articleNo + "/" + replyPageNum); // 댓글 목록 호출
...
// modal 창의 댓글 수정버튼 클릭 이벤트
    $(".modalModBtn").on("click", function () {
        ...
        $.ajax({
            type : "put",
            url : "/exchangers/replies/" + replyNo,
            headers : {
                "Content-Type" : "application/json",
